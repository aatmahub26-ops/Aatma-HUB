  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         ...
         <Link href="/referral" className="glass-card p-6 rounded-3xl border-secondary/20 group hover:bg-secondary/5 transition-all">
            <div className="flex items-center justify-between">
               <div>
                  <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Squad Earnings</p>
                  <p className="text-3xl font-headline font-bold text-white mt-1">₹{referralStats.earnings.toFixed(2)}</p>
               </div>
        ...
        <div className="lg:col-span-4 space-y-6">
           ...
           <Card className="bg-primary/5 border-primary/20 rounded-[2rem] overflow-hidden">
              ...
              <CardContent className="p-6 space-y-4">
                 <p className="text-[10px] text-muted-foreground leading-relaxed font-medium">Aatma AI can track orders, suggest meta builds, and resolve wallet queries instantly.</p>
                 <Button className="w-full h-10 font-bold uppercase tracking-widest text-[10px] neon-glow" asChild>
                    <Link href="/ai-assistant">Initialize Chat</Link>
                 </Button>
              </CardContent>
           </Card>
        </div>
